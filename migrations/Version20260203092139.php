 ...
 */
final class Version20260203092139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD campus_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD organisateur_sortie_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_3C3FD3F2F147E7E1 ON sortie (organisateur_sortie_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3C3FD3F2F147E7E1 ON sortie');
        $this->addSql('ALTER TABLE sortie DROP campus_id, DROP lieu_id, DROP organisateur_sortie_id');
